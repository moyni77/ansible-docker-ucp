## What is this
This bunch of playbooks will install Docker EE on top of a Simplivity environment using vCenter. The whole environment is created from a single temlate having RHEL 7.3 as the OS. It will install:
...
## playbooks/install\_elk\_stack.yml

This playbook will configure a monitoring system for the Development Docker environment by making use of ELK Stack.

Add details here..

## playbooks/install\_cloudbees.yml

This playbook will install and configure Cloudbees Team edition software for CD\/CI Pipeline 

Add details here..

## playbook/config\_playwithdocker.yml

This playbook will configure Play With Docker a crash and burn environment dev tool. With containers auto expiring after 24 hours.
